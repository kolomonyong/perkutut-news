...
class FrontController extends Controller
{
    ...
    public function author(Author $author)
    {
        ...
        $articles = ArticleNews::where('author_id', $author->id)
            ->with(['category'])
            ->latest()
            ->get();

        return view('front.author', compact('author', 'categories', 'bannerads', 'articles'));
    }
    ...
    public function details(ArticleNews $articleNews)
    {
        ...
        return view('front.details', compact('articleNews', 'categories', 'bannerads', 'articles', 'square_ads_1', 'square_ads_2', 'author_news'));
    }
}
